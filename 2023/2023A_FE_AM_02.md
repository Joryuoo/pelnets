...
$n$ is a binary integer represented in twoâ€™s complement. Which of the following operations get the value $7 \times n$ using only bit shifting and an addition or subtraction operation?
...
- [Bitwise operators â€” Facts and Hacks | by Shashank Mohabia | Medium](https://medium.com/@shashankmohabia/bitwise-operators-facts-and-hacks-903ca516f28c)
