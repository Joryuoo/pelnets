...
b) Enabling the synchronization of time by returning an accurate time to a userâ€™s request 
...
> - These certificates create a secure connection for both public web pages and private systemsâ€”such as your virtual private network (VPN), internal Wi-Fi, wiki pages, and other services that support MFA.
