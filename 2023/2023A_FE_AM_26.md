...
- **EmployeeID â†’ EmployeeName**: This means that each **EmployeeID** uniquely determines the corresponding **EmployeeName**. If you know the **EmployeeID**, you can always determine the **EmployeeName**.
    
- **DepartmentID â†’ DepartmentName**: This means that for each **DepartmentID**, there is a unique **DepartmentName**. If you know the **DepartmentID**, you can uniquely determine the **DepartmentName**.
