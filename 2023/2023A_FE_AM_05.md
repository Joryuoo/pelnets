...
Category: #number-systems/2023  #year/2023
Status: #philnits
...
2+5Ã—3+4 in infix notation? Here, the operator â€œÃ—â€ has higher precedence than â€œ+â€. 
...
We are trying to convert 2+5Ã—3+4 from infix to postfix.
- this is equivalent to 2+(5Ã—3)+4
...
We want to execute `(5Ã—3)` first, so we need the `5 3 x` combination.
...
- [4.9. Infix, Prefix and Postfix Expressions â€” Problem Solving with Algorithms and Data Structures](https://runestone.academy/ns/books/published/pythonds/BasicDS/InfixPrefixandPostfixExpressions.html)
