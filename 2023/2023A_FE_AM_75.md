...
Which of the following is an officer whose primary responsibility is the security of a companyâ€™s information and data?
a) CCO
b) CIO
c) CISO
d) COO
...
### a) **CCO â€“ Chief Compliance Officer**
...
### b) **CIO â€“ Chief Information Officer**

- The **CIO** is responsible for the overall technology strategy of the company. They oversee the management, implementation, and usability of technology and information systems. The CIO ensures that the companyâ€™s IT infrastructure aligns with its business goals.
...
### c) **CISO â€“ Chief Information Security Officer** (Correct Answer)

- The **CISO** is specifically responsible for the security of a companyâ€™s information and data. Their main focus is on protecting the organizationâ€™s sensitive data from security threats, such as hacking, breaches, and malware. They develop and implement the companyâ€™s cybersecurity strategies and policies.
...
### d) **COO â€“ Chief Operating Officer**
