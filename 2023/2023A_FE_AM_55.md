...
- **d) Setting a service level under the cost and needs of a service provider and its customers**: This is the best approach. An SLA should consider both the customer's expectations (such as performance, availability, and support) and the providerâ€™s ability to deliver those services cost-effectively. It should strike a balance that is mutually beneficial.
