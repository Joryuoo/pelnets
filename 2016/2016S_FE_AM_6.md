...
Category: #automata-theory/2016  #year/2016
Status: #philnits
...
### Why E Ã¢â€ â€™ 7 + 3 * (F + T) works:

1. First, verify this specific sequence can generate our target "7 + 3 * (6 + 4)":
    - 7 is already there
    - 3 is already there
    - F can derive a single digit (F Ã¢â€ â€™ C Ã¢â€ â€™ 6)
    - T can derive a single digit (T Ã¢â€ â€™ F Ã¢â€ â€™ C Ã¢â€ â€™ 4)
2. The other options fail because: b) E Ã¢â€ â€™ 7 + 3 * E
