...
Category: #algorithms/2021  #year/2021
Status: #philnits
...
The GCD (Greatest Common Divisor) of two positive integers, $x_0$ and $x_1 (x_0 > x_1)$, is computed by the procedure below. When $x_{0} = 175$ and $x_1 = 77$, how many times should step `(2)` of this procedure be executed before it stops? Here, â€œ$A â† B$ â€ indicates that B is substituted for A.
