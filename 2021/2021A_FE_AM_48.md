...
Category:  #object-oriented-programming/2021  #year/2021
Status: #philnits
...
b) To pass arguments that control another moduleâ€™s logic when the module is called 
...
According to [kharagpurcollege.ac.in/studyMaterial/173830Lecture-9-Coupling-cohesion, 2nd semester by Alok Haldar.pdf](https://www.kharagpurcollege.ac.in/studyMaterial/173830Lecture-9-Coupling-cohesion,%202nd%20semester%20by%20Alok%20Haldar.pdf), The coupling isÂ **the degree of interdependence between software modules**. Two modules that are tightly coupled are strongly dependent on each other. Two modules that areÂ loosely coupledÂ are not dependent on each other.
