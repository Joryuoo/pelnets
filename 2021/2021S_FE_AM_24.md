...
- used to create digital images and graphics in 2D or 3D:Â 
	- ==**Vector graphics**:Â Drawing programs use vector graphics, which allows users to isolate, move, and scale elements of an image independently.Â ==
	- **Special effects**:Â Drawing programs often include special effects for creating illustrations.Â 
	- **Popular programs**:Â Some popular drawing programs include Adobe Illustrator, CorelDRAW, and Macromedia Freehand.
