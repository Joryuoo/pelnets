...
### Option b)
- Â process of pulling data from a database and saving it as a structured file
- similar to option a)
...
### Option d)
- Â â€œundoâ€ button for database changes
- Â eliminates the problematic change and the issues it caused for the infrastructure, application, data, and end users
...
- [Database dump definition â€“ Glossary | NordVPN](https://nordvpn.com/cybersecurity/glossary/database-dump/#:~:text=A%20database%20dump%20(or%20%E2%80%9Cdump,and%20sometimes%20other%20related%20information.)
