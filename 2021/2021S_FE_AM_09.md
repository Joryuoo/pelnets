...
Category: #programming/2021 #year/2021
Status: #philnits
...
> A recursive function is aÂ [function](https://techterms.com/definition/function)Â that ==calls itself during its execution==. The process may repeat several times, outputting the result and the end of eachÂ [iteration](https://techterms.com/definition/iteration).
