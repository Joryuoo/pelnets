...
Category: #hardware/2021 #year/2021
Status: #philnits
...
b) It is a serial interface that has a data transmission mode of 5 Gbit/s that is called super speed.
## Definition
USB 3.0, also known as SuperSpeed USB, isÂ a Universal Serial Bus (USB) data transfer standard that's commonly used to connect external devices to computers:Â 

- **Speed**:Â 5â€“20 Gbps.Â 
- **Compatibility**:Â backwards compatible with USB 2.0 and USB 1.1 devices.Â 
- **Symbol**:Â standard USB trident logo with an "SS" inscription and a transfer speed capability above the trident.Â 
- **Ports**:Â usually blue, while USB 2.0 ports are black or white.Â 
