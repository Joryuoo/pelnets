...
Category: #operating-systems/2021  #year/2021
Status: #philnits
...
1)  **Save the current process**:Â The OS saves the state of the current process into a process control block (PCB).Â 
2) **Load the next process**:Â The OS loads the PCB of the next process to be executed.Â 
3) **Transfer control**:Â The OS transfers control to the next process.
