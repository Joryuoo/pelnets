...
- **Why it's not correct**: While expert judgment is useful, itâ€™s not a group decision-making technique. It usually involves a few experts providing input, not a structured group-based approach like brainstorming or Delphi techniques.
...
- **Why it's not correct**: Parametric estimating is not a group decision-making technique. Itâ€™s a quantitative method that uses historical data and mathematical formulas rather than team-based collaboration to make estimates.
