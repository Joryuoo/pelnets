...
a) An attack by encrypting victimâ€™s data and demanding ransom 
b) An attack by looking at someoneâ€™s keyboard while the victim entering a password 
...
overload the victimâ€™s computer 
? 
c) An attack by masquerading as someone such as a superior person from an information 
systems department, or customer 
...
### d) An attack by sending excessive requests from multiple computers in an attempt to overload the victimâ€™s computer 
