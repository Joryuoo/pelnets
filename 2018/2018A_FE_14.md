...
Category: #operating-systems/2018  #year/2018
Status: #philnits
...
> [!info] In computing, a cache is **a high-speed data storage layer which stores a subset of data, typically transient in nature, so that future requests for that data are served up faster** than is possible by accessing the dataâ€™s primary storage location.
