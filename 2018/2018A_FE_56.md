...
Category: #devops/2018  #year/2018
Status: #philnits
...
- **Why itâ€™s not correct**: This method places the entire responsibility of testing on the operations team without support from development. Since the development team is familiar with the system's design and architecture, excluding them during testing can lead to gaps in understanding and failure to identify critical issues. Smooth integration requires collaboration, especially during testing.
