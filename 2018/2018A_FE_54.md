...
Category: #project-management/2018  #year/2018
Status: #philnits
...
- **Why itâ€™s not correct**: Analogous estimating does not focus on parametric models or system complexity but rather on using past projects as reference points.
...
- **Why itâ€™s not correct**: Bottom-up estimating is more granular and time-consuming and doesnâ€™t use parametric models or focus on system complexity.
...
- **Why itâ€™s correct**: The function point method uses a parametric model to create objective estimates based on the size and complexity of the system, making it appropriate for the scenario described in the question.
...
- **Why itâ€™s not correct**: Three-point estimating deals with uncertainty by considering different scenarios, but it doesnâ€™t rely on parametric models or focus on system complexity.
