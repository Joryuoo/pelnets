...
TheÂ **critical path method (CPM)**Â is a sophisticated project management technique for planning, scheduling, and managing the tasks necessary to complete a project from start to finish. It is also sometimes referred to asÂ **critical path analysis (CPA)**.Â 

The critical path method does two main things:

1. It helps project managers find the most important tasks in a project thatÂ _critically_Â affect how long a project will take.Â 
