...
Category: #project-management/2019  #year/2019
Status: #philnits
...
**a) The critical path is A â€“ C â€“ G.** 
...
The **Critical Path** is the longest stretch of dependent activities and is crucial for determining the projectâ€™s duration. Any delay in the activities on the critical path will result in a delay in the overall project completion. The critical path of this diagram is B - F - G as the sum of its values is 12 days. Removing F out of the equation will transfer the critical path to B - D - H whose sum of its values is equal to 11 days. Therefore, the project will end 1 day earlier.
