...
Category: #operating-systems/2019  #year/2019
Status: #philnits
...
**a) When A is launched during the execution of B, B is assigned a â€œreadyâ€ status and A is executed.** 

**b) When A is launched during the execution of B, B is assigned a â€œwaitingâ€ status and A is executed.** 

**c) When B is launched during the execution of A, A is assigned a â€œreadyâ€ status and B is executed.** 

**d) When B is launched during the execution of A, A is assigned a â€œwaitingâ€ status and B is executed**.
?
**a) When A is launched during the execution of B, B is assigned a â€œreadyâ€ status and A is executed.** 
## **Explanation:**

In a **preemptive scheduling** system, tasks with **higher priority** can interrupt or "preempt" the execution of lower-priority tasks. Hereâ€™s the breakdown:
