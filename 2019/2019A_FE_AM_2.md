...
Category: #digital-logic/2019  #year/2019
Status: #philnits
...
### Calculating Hamming distance
	In order to calculate the Hamming distance between two strings, and , we perform their XOR operation, (aâŠ•b), and then count the total number of 1s in the resultant string.

##### Example
101 âŠ• 111 = 010, d(011, 111) = 1
011 âŠ• 101 = 110, d(011, 101) = 2
010 âŠ• 101 = 111, d(010, 101) = 3

##### Therefore
10101 âŠ• 11110 = 01011, d(10101, 11110) = 3
