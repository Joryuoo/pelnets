...
Category: #business-administration/2019 #year/2019
Status: #philnits
...
| -------------------- | -------------------------- | ------------------------- |
| **Existing Product** | âœ… **Market Penetration**  | âž¡ï¸ **Market Development** |
| **New Product**      | âž¡ï¸ **Product Development** | ðŸ” **Diversification**    |

**a) Diversification**
Out of the four strategies, this is the **riskiest** growth strategy. This strategy involves launching a new product in a new marketâ€”which means there would be no existing customer base, no proven demand, and no product history to rely on.
