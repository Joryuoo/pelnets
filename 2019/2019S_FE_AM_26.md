...
Category: #information-management/2019  #year/2019
Status: #philnits
...
2. **Subquery 2 (`SELECT DNO FROM DEPT_LOCS WHERE Region=â€™L2â€™)**: This part retrieves the department numbers (DNO) for departments located in the **L2** region from the **DEPT_LOCS** table.
