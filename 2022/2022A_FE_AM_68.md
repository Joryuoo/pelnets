...
- **a) Bathtub curve:** This is a graphical representation used in reliability engineering, showing failure rates of products. It has a "bathtub" shape, with high failure rates early on (infant mortality), low constant failure rates during the productâ€™s life, and increasing failure rates toward the end (wear-out).
