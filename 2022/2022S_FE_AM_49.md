...
- B) Functional test: Functional testing ensures that each function of the software operates according to specifications. It checks the application's functionality by providing inputs and comparing the actual output to the expected one, but it doesnâ€™t focus on the interactions between multiple parts or modules of the system.
