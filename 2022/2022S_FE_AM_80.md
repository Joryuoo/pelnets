...
- **c) Shorten the time period for collecting accounts receivable.**
    ...
    This option refers to **speeding up the collection of money** owed to the company. By receiving payments faster, cash comes into the business more quickly, improving the companyâ€™s liquidity. This is a positive action that **improves cash flow**.
