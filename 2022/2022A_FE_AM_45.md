...
Category: #systems-architecture/2022 #year/2022
Status: #philnits
...
**a) It shows the behavior during the objectâ€™s life cycle using finite state transitions.**

**b) It shows the exchange of messages among objects and objectsâ€™ lifelines in a time series.**
...
The use case diagram helps in visualizing the relationships between actors and use cases, highlighting what the system does from the userâ€™s perspective.
