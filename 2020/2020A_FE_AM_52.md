...
After the reduction, the critical path becomes **Path 1: A â†’ B â†’ E** with 15 days, and the new project duration is reduced by **1 day** (from 16 days to 15 days). Making the answer b) Project duration is reduced by 1 day.
%% ignore this %%
---
