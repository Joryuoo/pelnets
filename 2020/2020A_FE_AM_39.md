...
d) is incorrect because **encrypting a message** is usually done using the **recipientâ€™s public key**, not the senderâ€™s private key. The private key is used for signing, not encrypting messages for confidentiality.
%% ignore this %%
---
