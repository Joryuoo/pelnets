...
c) It is an attack in which a malicious script is executed on the visitorâ€™s web browser by sending the malicious code to the website displaying the visitorâ€™s input data. 
