...
Category: #project-management/2020  #year/2020
Status: #philnits 
...
**a) Brainstorming** â€“ This is a technique used for generating ideas or solutions, not for monitoring process stability.

**b) Cause-and-effect diagram** â€“ Also known as a fishbone diagram, it is used to identify potential causes of problems but does not track process stability over time.

**d) Run chart** â€“ A run chart also plots data over time, but it doesn't have control limits like a control chart, making it less useful for determining process stability.
