...
Category: #service-management/2020 #year/2020
Status: #philnits
...
**a) Evaluating customer satisfaction and performing reviews** â€“ This is part of **service level management**, which focuses on ensuring service performance aligns with agreed targets, not incident management.

**b) Examining free disk space** â€“ This is part of **capacity management** or **monitoring**, not incident and service request management.

**c) Investigating the impact of changes** â€“ This falls under **change management**, which deals with assessing the impact of changes to the IT environment, not incidents or service requests.
