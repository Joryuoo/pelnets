...
Category: #hardware/2020  #year/2020
Status: #philnits
...
- **a) RAID 0**: This does **not** provide redundancy. Instead, it uses **striping**, where data is split across multiple disks. It improves performance but offers no fault toleranceâ€”if one disk fails, all data is lost.
...
a) **Incorrect**
- RAID 0 uses **striping**, where data is split across multiple disks. It improves performance but offers no fault toleranceâ€”if one disk fails, all data is lost.
c) **Incorrect**
