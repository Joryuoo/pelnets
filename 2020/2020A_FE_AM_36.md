...
**d) RSA (Rivestâ€“Shamirâ€“Adleman)** -  a **public-key encryption algorithm** that relies specifically on the difficulty of breaking down a large number into the two prime numbers that were used to create it.
### Other Options
