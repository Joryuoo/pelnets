...
Category: #data-encoding/2024  #year/2024
Status: #philnits
...
Â L (buffer size) should not undergo buffer overflow, thus L should be greater than or equal to the amount of data in the buffer
