...
Category: #project-management/2024 #year/2024
Status: #philnits
...
Learning the system â†’ Learning the problem â†’ Making/Construct the solution â†’ Evaluate Performance.
...
The next choice that would be eliminated is A because step in A directly goes to making a solution without prior knowledge about the new task.Â 
