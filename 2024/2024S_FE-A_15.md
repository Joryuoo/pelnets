...
a) It is advanced search technology that determines the intention of a userâ€™s search request by adding recognition and decision functions to an object that combines data and its processing.
