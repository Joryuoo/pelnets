...
Category: #digital-logic/2024  #year/2024
Status: #philnits
...
1. x and y are inputs to a NAND gate. The output of the NAND gate is â€‹x y, which is the inversion of the AND operation.
    
2. z goes through a NOT gate before being input to the OR gate. So the value entering the OR gate from z is â€‹z.
    
3. The final output function comes from the OR gate, which takes â€‹x yâ€‹ (from the NAND gate) and â€‹z (from the NOT gate).
